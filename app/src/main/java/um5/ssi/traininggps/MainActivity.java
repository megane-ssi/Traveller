...
//______________________________________________________________________
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_showWayPointList = findViewById(R.id.btn_showWayPointList2);
        ...
        btn_newWayPoint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Add the location to the table of WayPoints

                WayPoint wayPoint = null;
                try {
                    wayPoint = new WayPoint((String) tv_address.getText(), new Date().toString(), (int) new Date().getTime(), currentLocation.getLatitude(), currentLocation.getLongitude());
                    Toast.makeText(MainActivity.this,"waypoint registered",Toast.LENGTH_SHORT).show();
                }
                catch (Exception e) {
                    Toast.makeText(MainActivity.this,"Not able to register waypoint",Toast.LENGTH_SHORT).show();
                }

                FeedReaderDbHelper feedReaderDbHelper = new FeedReaderDbHelper(MainActivity.this);

                boolean success = feedReaderDbHelper.addOne(wayPoint);
            ...
            fusedLocationProviderClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>(){
                ...
                public void onSuccess(Location location) {
                    ...
                    if (location  != null) {
                        ...
                        tv_lat.setText("Not_available");
                        tv_lon.setText("Not_available");
                        tv_accuracy.setText("Not_available");
    ...
    private void updateUIValues(Location location) {
        ...
        FeedReaderDbHelper feedReaderDbHelper = new FeedReaderDbHelper(MainActivity.this);
        tv_countOfWayPoints.setText(Integer.toString(feedReaderDbHelper.getAll().size()));//lines of the db table
